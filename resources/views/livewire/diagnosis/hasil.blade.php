<div>
    <div class="card shadow-lg h-100 animate__fadeIn" style="background: var(--card-bg); border: none; border-radius: 12px; padding: 2rem;">
        ...
        <div class="mb-4 px-3">
            @if($typeHasil === 'kosong')
                <div class="alert alert-warning d-flex align-items-center" style="border-radius: 8px; background-color: #fff3cd; color: #856404;">
                    <i class="fas fa-exclamation-triangle me-2"></i>
                    <span class="fw-bold">Tidak ditemukan penyakit berdasarkan gejala yang dipilih.</span>
                </div>

                <div class="mt-4 text-end">
                    <a wire:click="repeatDiagnosis" class="btn btn-primary" style="background-color: var(--primary); border-color: var(--primary); padding: 0.5rem 1.5rem; font-weight: 600; border-radius: 8px;">
            ...
            @else
                ...
                <div class="mb-4">
                    ...
                    <div class="progress" style="height: 28px; border-radius: 8px; background-color: #e9ecef;">
                        <div class="progress-bar bg-success" role="progressbar" style="width: {{ $cf === 0.0 ? 0 : $cf * 100 }}%; background-color: var(--primary); font-size: 1rem;" aria-valuenow="85" aria-valuemin="1" aria-valuemax="100">
